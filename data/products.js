...
class Appliances extends Product {
  ...
  extraInfoHTML() {
    return `<a href="images/appliance-instructions.png"
    target="_blank">Instructions</a></br>
    <a href="images/appliance-warranty.png"
...
export const products = [
  ...
  },
  {
    ...
    name: "School Backpack - Black",
    rating: {
      stars: 5,
      count: 7070,
    },
    priceCents: 1000,
    keywords: ["backpack", "school", "university"],
  },
  {
    id: "bc2847e9-5323-403f-b7cf-57fde044a957",
    image: "images/products/umbrella.jpg",
    name: "Water-Proof Umbrella - Large",
    rating: {
      stars: 3.5,
      count: 333,
    },
    priceCents: 765,
    keywords: ["umbrella", "rain", "snow"],
  },
].map((productDetails) => {
  if (productDetails.type === "clothing") {
    return new Clothing(productDetails);
